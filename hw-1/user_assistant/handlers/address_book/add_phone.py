...
class AddressBookAddPhoneHandler(AddressBookAbstract):
    def create_phone(self):
        ...
        new_phone, record = input_value(
            "new phone", Phone, placeholder=Phone.PHONE_FORMAT_EXAMPLE
        )
    ...
    def execute(self):
        ...
        Console.print_table(
            "Updated contact phone", address_book_titles, [get_address_book_row(record)]
        )
