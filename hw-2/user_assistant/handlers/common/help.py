...
address_book_documentation = [
    [
        CommandEnum.ADD_CONTACT.value,
        "name, birthday, phone, address, mail",
        "Create a new contact",
    ],
    [
        CommandEnum.EDIT_CONTACT.value,
        "name, birthday, address, mail",
    ...
    [
        CommandEnum.SEARCH_CONTACTS.value,
        "name or phone",
    ...
    [
        ...
        "days",
        "Show contacts who birthdays will be in period of entered days",
    ],
]
...
sort_files_documentation = [
    [
        CommandEnum.SORT_FILES.value,
        "folder",
        "Sorting files inside folder by categories: music, image, video, documents",
    ],
]
...
class HelpHandler(AbstractHandler):
    def execute(self):
        ...
        Console.print_table(
            "Additionals",
            list(filter(lambda title: title != "Fields", column_titles)),
            additional_CommandEnum_documentation,
        )
